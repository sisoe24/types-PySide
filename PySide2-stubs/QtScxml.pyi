...
class QScxmlDynamicScxmlServiceFactory(QScxmlInvokableServiceFactory):
    staticMetaObject: typing.ClassVar[PySide2.QtCore.QMetaObject] = ...
    def __init__(self, invokeInfo: QScxmlExecutableContent.InvokeInfo, names: typing.List[int], parameters: typing.List[QScxmlExecutableContent.ParameterInfo], parent: typing.Optional[PySide2.QtCore.QObject] = ..., destroyed: typing.Callable[..., typing.Any] = ..., objectName: str = ..., objectNameChanged: typing.Callable[..., typing.Any] = ...) -> None: ...
...
class QScxmlEcmaScriptDataModel(QScxmlDataModel):
    staticMetaObject: typing.ClassVar[PySide2.QtCore.QMetaObject] = ...
    def __init__(self, parent: typing.Optional[PySide2.QtCore.QObject] = ..., destroyed: typing.Callable[..., typing.Any] = ..., objectName: str = ..., objectNameChanged: typing.Callable[..., typing.Any] = ..., stateMachine: typing.Any = ..., stateMachineChanged: typing.Callable[..., typing.Any] = ...) -> None: ...
    def evaluateAssignment(self, id: int) -> bool: ...
    def evaluateForeach(self, id: int, body: QScxmlDataModel.ForeachLoopBody) -> bool: ...
    def evaluateInitialization(self, id: int) -> bool: ...
    def evaluateToBool(self, id: int) -> typing.Tuple[bool,bool]: ...
...
class QScxmlInvokableService(PySide2.QtCore.QObject):
    staticMetaObject: typing.ClassVar[PySide2.QtCore.QMetaObject] = ...
    def __init__(self, parentStateMachine: QScxmlStateMachine, parent: QScxmlInvokableServiceFactory, destroyed: typing.Callable[..., typing.Any] = ..., objectName: str = ..., objectNameChanged: typing.Callable[..., typing.Any] = ...) -> None: ...
    def id(self) -> str: ...
    def name(self) -> str: ...
...
class QScxmlStateMachine(PySide2.QtCore.QObject):
    ...
    def __init__(self, metaObject: PySide2.QtCore.QMetaObject, parent: typing.Optional[PySide2.QtCore.QObject] = ..., destroyed: typing.Callable[..., typing.Any] = ..., objectName: str = ..., objectNameChanged: typing.Callable[..., typing.Any] = ...) -> None: ...
...
class QScxmlStaticScxmlServiceFactory(QScxmlInvokableServiceFactory):
    staticMetaObject: typing.ClassVar[PySide2.QtCore.QMetaObject] = ...
    def __init__(self, metaObject: PySide2.QtCore.QMetaObject, invokeInfo: QScxmlExecutableContent.InvokeInfo, nameList: typing.List[int], parameters: typing.List[QScxmlExecutableContent.ParameterInfo], parent: typing.Optional[PySide2.QtCore.QObject] = ..., destroyed: typing.Callable[..., typing.Any] = ..., objectName: str = ..., objectNameChanged: typing.Callable[..., typing.Any] = ...) -> None: ...
    def invoke(self, parentStateMachine: QScxmlStateMachine) -> QScxmlInvokableService: ...
