...
class QGLPixelBuffer(PySide2.QtGui.QPaintDevice):
    ...
    @overload
    def __init__(self, size: PySide2.QtCore.QSize, format: QGLFormat = ..., shareWidget: typing.Optional[QGLWidget] = ...) -> None: ...
    @overload
...
class QGLShader(PySide2.QtCore.QObject):
    ...
    @overload
    def __init__(self, type: typing.Union[QGLShader.ShaderType,QGLShader.ShaderTypeBit], context: QGLContext, parent: typing.Optional[PySide2.QtCore.QObject] = ..., destroyed: typing.Callable[..., typing.Any] = ..., objectName: str = ..., objectNameChanged: typing.Callable[..., typing.Any] = ...) -> None: ...
    @overload
    def __init__(self, type: typing.Union[QGLShader.ShaderType,QGLShader.ShaderTypeBit], parent: typing.Optional[PySide2.QtCore.QObject] = ..., destroyed: typing.Callable[..., typing.Any] = ..., objectName: str = ..., objectNameChanged: typing.Callable[..., typing.Any] = ...) -> None: ...
    @overload
    ...
    @classmethod
    def hasOpenGLShaders(cls, type: typing.Union[QGLShader.ShaderType,QGLShader.ShaderTypeBit], context: typing.Optional[QGLContext] = ...) -> bool: ...
...
class QGLShaderProgram(PySide2.QtCore.QObject):
    staticMetaObject: typing.ClassVar[PySide2.QtCore.QMetaObject] = ...
    @overload
    def __init__(self, context: QGLContext, parent: typing.Optional[PySide2.QtCore.QObject] = ..., destroyed: typing.Callable[..., typing.Any] = ..., objectName: str = ..., objectNameChanged: typing.Callable[..., typing.Any] = ...) -> None: ...
    @overload
    ...
    @classmethod
    def hasOpenGLShaderPrograms(cls, context: typing.Optional[QGLContext] = ...) -> bool: ...
