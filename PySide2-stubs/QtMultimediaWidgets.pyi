...
class QCameraViewfinder(QVideoWidget):
    ...
    def __init__(self, parent: typing.Optional[PySide2.QtWidgets.QWidget] = ..., acceptDrops: bool = ..., accessibleDescription: str = ..., accessibleName: str = ..., aspectRatioMode: PySide2.QtCore.Qt.AspectRatioMode = ..., autoFillBackground: bool = ..., baseSize: PySide2.QtCore.QSize = ..., brightness: int = ..., brightnessChanged: typing.Callable[..., typing.Any] = ..., childrenRect: PySide2.QtCore.QRect = ..., childrenRegion: PySide2.QtGui.QRegion = ..., contextMenuPolicy: PySide2.QtCore.Qt.ContextMenuPolicy = ..., contrast: int = ..., contrastChanged: typing.Callable[..., typing.Any] = ..., cursor: typing.Union[PySide2.QtGui.QCursor,PySide2.QtCore.Qt.CursorShape] = ..., customContextMenuRequested: typing.Callable[..., typing.Any] = ..., destroyed: typing.Callable[..., typing.Any] = ..., enabled: bool = ..., focus: bool = ..., focusPolicy: PySide2.QtCore.Qt.FocusPolicy = ..., font: PySide2.QtGui.QFont = ..., frameGeometry: PySide2.QtCore.QRect = ..., frameSize: PySide2.QtCore.QSize = ..., fullScreen: bool = ..., fullScreenChanged: typing.Callable[..., typing.Any] = ..., geometry: PySide2.QtCore.QRect = ..., height: int = ..., hue: int = ..., hueChanged: typing.Callable[..., typing.Any] = ..., inputMethodHints: typing.Union[PySide2.QtCore.Qt.InputMethodHints,PySide2.QtCore.Qt.InputMethodHint] = ..., isActiveWindow: bool = ..., layoutDirection: PySide2.QtCore.Qt.LayoutDirection = ..., locale: PySide2.QtCore.QLocale = ..., maximized: bool = ..., maximumHeight: int = ..., maximumSize: PySide2.QtCore.QSize = ..., maximumWidth: int = ..., mediaObject: PySide2.QtMultimedia.QMediaObject = ..., minimized: bool = ..., minimumHeight: int = ..., minimumSize: PySide2.QtCore.QSize = ..., minimumSizeHint: PySide2.QtCore.QSize = ..., minimumWidth: int = ..., modal: bool = ..., mouseTracking: bool = ..., normalGeometry: PySide2.QtCore.QRect = ..., objectName: str = ..., objectNameChanged: typing.Callable[..., typing.Any] = ..., palette: PySide2.QtGui.QPalette = ..., pos: PySide2.QtCore.QPoint = ..., rect: PySide2.QtCore.QRect = ..., saturation: int = ..., saturationChanged: typing.Callable[..., typing.Any] = ..., size: PySide2.QtCore.QSize = ..., sizeHint: PySide2.QtCore.QSize = ..., sizeIncrement: PySide2.QtCore.QSize = ..., sizePolicy: PySide2.QtWidgets.QSizePolicy = ..., statusTip: str = ..., styleSheet: str = ..., tabletTracking: bool = ..., toolTip: str = ..., toolTipDuration: int = ..., updatesEnabled: bool = ..., videoSurface: typing.Any = ..., visible: bool = ..., whatsThis: str = ..., width: int = ..., windowFilePath: str = ..., windowIcon: PySide2.QtGui.QIcon = ..., windowIconChanged: typing.Callable[..., typing.Any] = ..., windowIconText: str = ..., windowIconTextChanged: typing.Callable[..., typing.Any] = ..., windowModality: PySide2.QtCore.Qt.WindowModality = ..., windowModified: bool = ..., windowOpacity: float = ..., windowTitle: str = ..., windowTitleChanged: typing.Callable[..., typing.Any] = ..., x: int = ..., y: int = ...) -> None: ...
...
class QGraphicsVideoItem(PySide2.QtWidgets.QGraphicsObject, PySide2.QtMultimedia.QMediaBindableInterface):
    ...
    staticMetaObject: typing.ClassVar[PySide2.QtCore.QMetaObject] = ...
    def __init__(self, parent: typing.Optional[PySide2.QtWidgets.QGraphicsItem] = ..., aspectRatioMode: PySide2.QtCore.Qt.AspectRatioMode = ..., children: typing.Any = ..., childrenChanged: typing.Callable[..., typing.Any] = ..., destroyed: typing.Callable[..., typing.Any] = ..., effect: typing.Any = ..., enabled: bool = ..., enabledChanged: typing.Callable[..., typing.Any] = ..., height: float = ..., heightChanged: typing.Callable[..., typing.Any] = ..., mediaObject: PySide2.QtMultimedia.QMediaObject = ..., nativeSize: PySide2.QtCore.QSizeF = ..., nativeSizeChanged: typing.Callable[..., typing.Any] = ..., objectName: str = ..., objectNameChanged: typing.Callable[..., typing.Any] = ..., offset: PySide2.QtCore.QPointF = ..., opacity: float = ..., opacityChanged: typing.Callable[..., typing.Any] = ..., parentChanged: typing.Callable[..., typing.Any] = ..., pos: PySide2.QtCore.QPointF = ..., rotation: float = ..., rotationChanged: typing.Callable[..., typing.Any] = ..., scale: float = ..., scaleChanged: typing.Callable[..., typing.Any] = ..., size: PySide2.QtCore.QSizeF = ..., transformOriginPoint: PySide2.QtCore.QPointF = ..., videoSurface: PySide2.QtMultimedia.QAbstractVideoSurface = ..., visible: bool = ..., visibleChanged: typing.Callable[..., typing.Any] = ..., width: float = ..., widthChanged: typing.Callable[..., typing.Any] = ..., x: float = ..., xChanged: typing.Callable[..., typing.Any] = ..., y: float = ..., yChanged: typing.Callable[..., typing.Any] = ..., z: float = ..., zChanged: typing.Callable[..., typing.Any] = ...) -> None: ...
