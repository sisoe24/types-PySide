...
class QTextToSpeech(PySide2.QtCore.QObject):
    ...
    @overload
    def __init__(self, engine: str, parent: typing.Optional[PySide2.QtCore.QObject] = ..., destroyed: typing.Callable[..., typing.Any] = ..., locale: PySide2.QtCore.QLocale = ..., localeChanged: typing.Callable[..., typing.Any] = ..., objectName: str = ..., objectNameChanged: typing.Callable[..., typing.Any] = ..., pitch: float = ..., pitchChanged: typing.Callable[..., typing.Any] = ..., rate: float = ..., rateChanged: typing.Callable[..., typing.Any] = ..., state: typing.Any = ..., stateChanged: typing.Callable[..., typing.Any] = ..., voice: QVoice = ..., voiceChanged: typing.Callable[..., typing.Any] = ..., volume: float = ..., volumeChanged: typing.Callable[..., typing.Any] = ...) -> None: ...
    @overload
    def __init__(self, parent: typing.Optional[PySide2.QtCore.QObject] = ..., destroyed: typing.Callable[..., typing.Any] = ..., locale: PySide2.QtCore.QLocale = ..., localeChanged: typing.Callable[..., typing.Any] = ..., objectName: str = ..., objectNameChanged: typing.Callable[..., typing.Any] = ..., pitch: float = ..., pitchChanged: typing.Callable[..., typing.Any] = ..., rate: float = ..., rateChanged: typing.Callable[..., typing.Any] = ..., state: typing.Any = ..., stateChanged: typing.Callable[..., typing.Any] = ..., voice: QVoice = ..., voiceChanged: typing.Callable[..., typing.Any] = ..., volume: float = ..., volumeChanged: typing.Callable[..., typing.Any] = ...) -> None: ...
    @classmethod
