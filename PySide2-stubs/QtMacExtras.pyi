...
class QMacToolBar(PySide2.QtCore.QObject):
    ...
    @overload
    def __init__(self, identifier: str, parent: typing.Optional[PySide2.QtCore.QObject] = ..., destroyed: typing.Callable[..., typing.Any] = ..., objectName: str = ..., objectNameChanged: typing.Callable[..., typing.Any] = ...) -> None: ...
    @overload
...
class QMacToolBarItem(PySide2.QtCore.QObject):
    ...
    staticMetaObject: typing.ClassVar[PySide2.QtCore.QMetaObject] = ...
    def __init__(self, parent: typing.Optional[PySide2.QtCore.QObject] = ..., activated: typing.Callable[..., typing.Any] = ..., destroyed: typing.Callable[..., typing.Any] = ..., icon: PySide2.QtGui.QIcon = ..., objectName: str = ..., objectNameChanged: typing.Callable[..., typing.Any] = ..., selectable: bool = ..., standardItem: QMacToolBarItem.StandardItem = ..., text: str = ...) -> None: ...
